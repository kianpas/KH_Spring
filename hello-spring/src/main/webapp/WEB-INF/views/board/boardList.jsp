   		...
   		$.ajax({
	    	...
	    	success : function(data) {
	    		...
	    		select:function(event, selected){
					...
					$("#searchTitle").val(selected.item.label);
	    			console.log(title)
...
<input type="search" placeholder="제목 검색..." id="searchTitle" class="form-control col-sm-3 d-inline" value=""/>
